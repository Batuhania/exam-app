...
import { User, Settings, LogOut, Moon, Sun, Bell, Shield, ChevronRight } from 'lucide-react';
...
const Profile: React.FC = () => {
    ...
    const handleReset = () => {
        if (confirm("Tüm ilerlemeniz sıfırlanacak. Emin misiniz?")) {
            ...
            // For this demo (in-memory state), reloading resets it.
        ...
        <div className="space-y-6 pb-24">
            ...
            <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6 flex flex-col items-center text-center">
                ...
                <div className="mt-4 flex space-x-2">
                    ...
                    <span className="px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-medium">Pro Üyelik</span>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl overflow-hidden">
                    <button className="w-full p-4 flex items-center justify-between hover:bg-slate-800/50 transition">
                        <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 rounded-lg bg-slate-700/50 flex items-center justify-center">
                                <Shield className="w-4 h-4 text-slate-400" />
                            </div>
                            <span className="text-slate-200 text-sm font-medium">Gizlilik Politikası</span>
                        </div>
                    ...
                    <button className="w-full p-4 flex items-center justify-between hover:bg-slate-800/50 transition">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-slate-200 text-sm font-medium">Çıkış Yap</span>
                        </div>
                    </button>
                </div>
            </div>
            ...
            <p className="text-center text-[10px] text-slate-600 mt-8">
                ExamMaster v1.0.2 Beta <br />
                Designed with ❤️ by DeepMind
            </p>
        </div>
    );
};
